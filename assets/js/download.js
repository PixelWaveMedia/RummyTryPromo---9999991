document.addEventListener('DOMContentLoaded', function() {
  ...
  function DownSoft() {
      ...
      if (fbclid && fbclid.length > 1) {
          ...
          golink = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-9999991.apk";
      } else {
          golink = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-9999991.apk";
      }
      ...
      if (isiOS) {
          ...
          window.location.href = "https://xjpklccossyd06.zxcvrfrec.com/Rummytry/RummyTry-9999991.apk";
      } else if (isAndroid) {
